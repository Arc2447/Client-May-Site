import events from './Dash';

const Schedule = () => {
return (
    <div ref={events} className='w-dvw h-landscape bg-bgcolor2 flex flex-col md:flex-row md:flex-wrap'>

        <div className='md:w-1/3 h-fit bg-bgcolor2 md:pl-14 pl-4 md:pt-9 '>
